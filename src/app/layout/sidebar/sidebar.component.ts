...
export class SidebarComponent implements AfterViewChecked {
  ...
  constructor(private eRef: ElementRef, private settings: SettingsService) {
  ...
  isUserAllowed = (roles: Array<any>): boolean =>
    _.some(roles, (role) =>
      this.settings.getUserSetting("roles").includes(role)
    );
}
